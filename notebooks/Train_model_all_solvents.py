...
csv_path = '/blue/hennig/ericfonseca/NASA/VASPsol/Truhlar_Benchmarks/VaspPysol/data/vaspsol_data_3_17_2023.csv'
...
learning_curve_fname = f'learning_curve_all_solvents_{date_string}.png'
...
print(model_string)
filename = f'{model_string}{date_string}_all_solvents.pkl'
...
scaler_filename = f'scaler_all_solvents_{model_string}{date_string}.pkl'
...
parity_plot_fname = f'parity_plot_all_solvents_{date_string}.png'
